...
import { useAuth, useTheme,useSearch } from "../../hooks";
    ...
    <div className="bg-secondary shadow-sm shadow-gray-500">
      <Container className="p-2">
        <div className="flex justify-between items-center">
          ...
          <Link to="/allmovies" className="text-white font-semibold text-lg">
            Movies
          </Link>
          <Link to="/allwebseries" className="text-white font-semibold text-lg">
            Web Series
          </Link>
          <Link to="/alltvseries" className="text-white font-semibold text-lg">
            Tv Series
          </Link>
